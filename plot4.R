...
png("ExData_Plotting1/plot4.png", width = 508, height = 508, res = 72) ## I have made this file 508 pixels like the images from the https://github.com/rdpeng/ExData_Plotting1 in order to fin in the legend text in the third plot in plot 4
